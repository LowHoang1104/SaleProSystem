...
// Quan trọng: Convert java.util.Date về java.sql.Date
    ...
    public ArrayList<ProductAdmin> GetTop10BestSellingProductsLast7Days() {
        ...
        try {
            ...
            rs = stm.executeQuery();
            while (rs.next()) {
                data.add(new ProductAdmin(rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getInt(6),rs.getString(5)));
            }
        } catch (Exception e) {
    ...
    public ArrayList<ProductAdmin> GetTop10BestSellingProductsLast1Month() {
        ArrayList<ProductAdmin> data = new ArrayList<ProductAdmin>();
        try {
            String strSQL = "select top 10 d.ProductCode,d.ProductName,m.TypeName,n.SupplierName, Images,count(d.ProductCode) as 'Number sales'  from Invoices a \n"
                    + "                    join InvoiceDetails b on a.InvoiceID=b.InvoiceID join ProductVariants c on b.ProductVariantID=c.ProductVariantID \n"
                    + "                    join ProductMaster d on c.ProductCode=d.ProductCode join PurchaseDetails e on c.ProductVariantID=e.ProductVariantID \n"
                    + "                    join Purchases f on e.PurchaseID=f.PurchaseID join Suppliers n on f.SupplierID=n.SupplierID \n"
                    + "                    join ProductTypes m on d.TypeID=m.TypeID WHERE a.InvoiceDate >= DATEADD(DAY, -30, GETDATE())  group by  d.ProductCode,d.ProductName,m.TypeName,n.SupplierName,Images order by  [Number sales] desc ";
            stm = connection.prepareStatement(strSQL);
            rs = stm.executeQuery();
            while (rs.next()) {
                data.add(new ProductAdmin(rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getInt(6),rs.getString(5)));            }
    ...
    public ArrayList<ProductAdmin> GetTop10BestSellingProductsLast3Months() {
        ...
        try {
            String strSQL = "select top 10 d.ProductCode,d.ProductName,m.TypeName,n.SupplierName, Images,count(d.ProductCode) as 'Number sales'  from Invoices a \n"
                    ...
                    + "                    join ProductMaster d on c.ProductCode=d.ProductCode join PurchaseDetails e on c.ProductVariantID=e.ProductVariantID \n"
                    + "                    join Purchases f on e.PurchaseID=f.PurchaseID join Suppliers n on f.SupplierID=n.SupplierID \n"
                    + "                    join ProductTypes m on d.TypeID=m.TypeID WHERE a.InvoiceDate >= DATEADD(DAY, -90, GETDATE())  group by  d.ProductCode,d.ProductName,m.TypeName,n.SupplierName,Images order by  [Number sales] desc ";
            stm = connection.prepareStatement(strSQL);
            rs = stm.executeQuery();
            while (rs.next()) {
                data.add(new ProductAdmin(rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getInt(6),rs.getString(5)));            }
    ...
    public ArrayList<ProductAdmin> GetTop10BestSellingProductsLast6Months() {
        ...
        try {
            String strSQL = "select top 10 d.ProductCode,d.ProductName,m.TypeName,n.SupplierName,Images, count(d.ProductCode) as 'Number sales'  from Invoices a \n"
                    ...
                    + "                    join ProductMaster d on c.ProductCode=d.ProductCode join PurchaseDetails e on c.ProductVariantID=e.ProductVariantID \n"
                    + "                    join Purchases f on e.PurchaseID=f.PurchaseID join Suppliers n on f.SupplierID=n.SupplierID \n"
                    + "                    join ProductTypes m on d.TypeID=m.TypeID WHERE a.InvoiceDate >= DATEADD(DAY, -120, GETDATE())  group by  d.ProductCode,d.ProductName,m.TypeName,n.SupplierName,Images order by  [Number sales] desc ";
            stm = connection.prepareStatement(strSQL);
            rs = stm.executeQuery();
            while (rs.next()) {
                data.add(new ProductAdmin(rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getInt(6),rs.getString(5)));            }
...
"                    join ProductMaster d on c.ProductCode=d.ProductCode join PurchaseDetails e on c.ProductVariantID=e.ProductVariantID \n" +
"                    join Purchases f on e.PurchaseID=f.PurchaseID join Suppliers n on f.SupplierID=n.SupplierID \n" +
"                    join ProductTypes m on d.TypeID=m.TypeID group by  d.ProductCode,d.ProductName,m.TypeName,n.SupplierName,Images order by  [Number sales] desc";
            stm = connection.prepareStatement(strSQL);
            rs = stm.executeQuery();
            while (rs.next()) {
                data.add(new ProductAdmin(rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getInt(6),rs.getString(5)));
