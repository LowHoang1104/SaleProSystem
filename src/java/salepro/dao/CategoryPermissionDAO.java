...
public class CategoryPermissionDAO extends DBContext {
    ...
    public List<CategoryPermissions> getAllCategoryPermission() {
    ...
    public static void main(String[] args) {
        CategoryPermissionDAO dao = new CategoryPermissionDAO();
        System.out.println(dao.getCategoryPermissionByID(1).getCategoryName());
    }
}
