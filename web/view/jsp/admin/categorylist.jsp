<%-- 
    ...
    Created on : May 23, 2025, 2:04:44 PM
    Author     : tungd
--%>
            ...
            <div class="page-wrapper">
                <div class="content">
                    <div class="page-header">
                        ...
                        <div class="page-btn">
                            <a href="addbrand.html" class="btn btn-added"><img src="${pageContext.request.contextPath}/view/assets/img/icons/plus.svg" class="me-2" alt="img">Add Brand</a>
                        </div>
                    </div>
                                ...
                                <table class="table datanew">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="product-img">
                                                    <img src="${pageContext.request.contextPath}/view/assets/img/brand/colgate.png" alt="product">
                                                </a>
                                            </td>
                                            <td>Colgate</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="product-img">
                                                    <img src="${pageContext.request.contextPath}/view/assets/img/brand/samsung.png" alt="product">
                                                </a>
                                            </td>
                                            <td>samsung</td>
                                            <td>Electronics</td>
