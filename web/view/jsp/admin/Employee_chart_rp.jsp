...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">Top 5 employees have highest revenue</div>
                                </div>
                                <div class="card-body">
                                    <div>
        ...
        <script>
        // Dữ liệu từ JSP truyền vào, dùng JSTL in ra JS array đúng format
            const ctx = document.getElementById('chartBar1').getContext('2d');
            const chartBar1Labels = [
            <c:forEach items="${data}" var="lb" varStatus="loop">
                "${lb.getName()}"<c:if test="${!loop.last}">,</c:if>
            </c:forEach>
            ];
            const chartBar1Data = [
            <c:forEach items="${data}" var="dt" varStatus="loop">
                ${dt.getValue()}<c:if test="${!loop.last}">,</c:if>
            </c:forEach>
            ];
            const dataBar1 = {
                labels: chartBar1Labels,
                datasets: [{
                        label: 'Doanh thu',
                        data: chartBar1Data,
