...
<%@ page import="salepro.models.EmployeeReportModel" %>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
                    ...
                    <div class="report-container">
                        ...
                        <div class="report-sidebar">
                            ...
                            <div class="report-time-select-panel">
                                <div class="group">
                                    <span>Theo ngày</span>
                                    <form method="post" action="EmployeeReport"><button type="submit" name="today">Hôm nay</button></form>
                                    <form method="post" action="EmployeeReport"><button type="submit" name="yesterday">Hôm qua</button></form>
                                </div>
                                <div class="group">
                                    <span>Theo tuần</span>
                                    <form method="post" action="EmployeeReport"><button type="submit" name="thisWeek">Tuần này</button></form>
                                    <form method="post" action="EmployeeReport"><button type="submit" name="lastWeek">Tuần trước</button></form>
                                    <form method="post" action="EmployeeReport"><button type="submit" name="last7days">7 ngày qua</button></form>
                                </div>
                                <div class="group">
                                    <span>Theo tháng</span>
                                    <form method="post" action="EmployeeReport"><button type="submit" name="thisMonth">Tháng này</button></form>
                                    <form method="post" action="EmployeeReport"><button type="submit" name="lastMonth">Tháng trước</button></form>
                                    <form method="post" action="EmployeeReport"><button type="submit" name="last30days">30 ngày qua</button></form>
                                </div>
                                <div class="group">
                                    <span>Theo quý</span>
                                    <form method="post" action="EmployeeReport"><button type="submit" name="thisQuarter">Quý này</button></form>
                                    <form method="post" action="EmployeeReport"><button type="submit" name="lastQuarter">Quý trước</button></form>
                                </div>
                                <div class="group">
                                    <span>Theo năm</span>
                                    <form method="post" action="EmployeeReport"><button type="submit" name="thisYear">Năm nay</button></form>
                                    <form method="post" action="EmployeeReport"><button type="submit" name="lastYear">Năm trước</button></form>
                                </div>
                            ...
                            <div style="display: flex; gap: 8px; align-items: center;">
                                <form method="post" action="EmployeeReport" class="search-form">
                            ...
                            <div class="report-btn-group">
                                <form method="post" action="ExportSalary"><button class="report-btn" type="submit" name="type" value="employee">Excel</button></form>
                            </div>
                        </div>

                        <!-- Main Content: Bảng -->
                        <div class="report-main">
                            <h5>Top 10 nhân viên bán được nhiều hàng nhất</h5>
                            <div class="report-table-area">
                                ...
                                <c:if test="${viewMode eq 'chart'}">
                                    ...
                                    <%
    ArrayList<EmployeeReportModel> data = (ArrayList<EmployeeReportModel>) request.getAttribute("data");
    ...
    for (int i = 0; i < data.size(); i++) {
        EmployeeReportModel s = data.get(i);

        String name = s.getName().replace("'", "\\'");
        String money = s.getMoney();
        String product = s.getInvoice();
                                        ...
                                        const stockChart = new Chart(ctx, {
                                            data: {
                                                ...
                                                datasets: [
                                                    {
                                                        type: 'bar',
                                                        label: 'Tổng doanh thu từ hóa đơn (VND)',
                                                    ...
                                                    tooltip: {
                                                        callbacks: {
                                                            label: function (context) {
                                                                if (context.dataset.label === 'Tổng doanh thu từ hóa đơn (VND)') {
