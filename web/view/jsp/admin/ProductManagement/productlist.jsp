                ...
                <div class="sidebar-inner slimscroll">
                    <div id="sidebar-menu" class="sidebar-menu">
                        <ul>
                            ...
                            <li class="submenu">
                                <a href="javascript:void(0);"><img src="${pageContext.request.contextPath}/view/assets/img/icons/store.svg" alt="img"><span> Sales</span> <span class="menu-arrow"></span></a>
                                <ul>
                                    <li>Store</li>
                                    <li><a href="saleslist.html">Store List</a></li>
                                    <li><a href="pos.html">Add Store</a></li>
                                    <li>Warehouse</li>
                                    <li><a href="pos.html">Warehouse List</a></li>
                                    <li><a href="salesreturnlists.html">Add Warehouse</a></li>
                                </ul>
                            </li>                    
                        </ul>
                    </div>
