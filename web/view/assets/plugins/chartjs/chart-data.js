...
$(function(){'use strict'; $.ajax({
  url: '/ProductReportController',
  method: 'GET',
  dataType: 'json',
  success: function (data) {
    var labels = data.map(item => item.productName);
    var values = data.map(item => item.num);
